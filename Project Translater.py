        ...
        if (text_):
            ...
            for i, j in language.items():
                if (j == c3):
                    lan_ = i
            print(lan_)
            words = translator.translate(text_,src=lan, dest=str(lan_))
            print("hello")
...
languagesV = list(language.values())
lang1 = language.keys()
...
combo2 = ttk.Combobox(root, values=languagesV, font="RobotV 14", state="r")
